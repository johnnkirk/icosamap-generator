...
/*  if(!readdmsverts("vcoord00.doc",ico)) {   */
...
FACE whichface(ico,geog) ICOPARMS *ico;GEOG *geog; {
  int face,prefac,ffff;double hold,coord,lat,lon,fa,fo;
...
FACE icoproj0(ico,geog,mapp) ICOPARMS *ico;GEOG *geog;MAPP *mapp; {
  FACE face;double fa,fo,x0,y0,x1,y1,x2,y2,x3,y3,trm3,trm4,trm1,trm2,tx,ty;
